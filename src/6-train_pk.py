...
# Combine features from training, validation, and testing sets
all_features = np.concatenate((x_train, x_val, x_test), axis=0)
...
#probs = top3(y_prob_test, testIndex)
...
# Dump new features.pkl
new_features_file = "new_features.pkl"
with open(new_features_file, "wb") as f:
    pickle.dump(all_features, f)
print(f"New features saved to {new_features_file}")
